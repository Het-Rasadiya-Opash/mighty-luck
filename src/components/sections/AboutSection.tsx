...
export default function AboutSection() {
    ...
    return (
        <section className="flex flex-col items-center lg:items-start p-0 gap-[24px] lg:gap-[40px] w-full max-w-[1136px] mx-auto px-4 lg:px-0">
            <div 
                className={`flex flex-col items-center p-0 gap-[24px] lg:gap-[32px] w-full max-w-[1136px] relative isolate overflow-hidden transition-[max-height] duration-500 ease-in-out ${isExpanded ? 'max-h-[3000px]' : 'max-h-[500px] md:max-h-[600px] lg:max-h-[708px]'}`}
            >
                {/* 1st Group */}
                <div className="flex flex-col items-start p-0 gap-[16px] lg:gap-[24px] w-full max-w-[800px] flex-none z-0">
                    <h2 className="w-full lg:w-[800px] font-['Jost'] font-bold text-[24px] md:text-[28px] lg:text-[32px] leading-[120%] tracking-[-0.02em] text-white flex-none m-0">
                        Play the Best Crypto Casino Games Online at Mighty Luck — Fast, Fair and Secure
                    </h2>
                    <p className="w-full lg:w-[800px] font-['Manrope'] font-medium text-[14px] md:text-[15px] lg:text-[16px] leading-[160%] text-[#D2DCF7] flex-none m-0 whitespace-pre-wrap">
                ...
                {/* 2nd Group */}
                <div className="flex flex-col items-start p-0 gap-[12px] lg:gap-[16px] w-full max-w-[800px] flex-none z-10">
                    <h3 className="w-full lg:w-[800px] font-['Jost'] font-bold text-[20px] md:text-[22px] lg:text-[24px] leading-[130%] lg:leading-[35px] text-white flex-none m-0">
                ...
                {/* 3rd Group */}
                <div className="flex flex-col items-start p-0 gap-[12px] lg:gap-[16px] w-full max-w-[800px] flex-none z-20 pb-[60px]">
                    <h3 className="w-full lg:w-[800px] font-['Jost'] font-bold text-[20px] md:text-[22px] lg:text-[24px] leading-[130%] lg:leading-[35px] text-white flex-none m-0">
                ...
                {/* Overlay / Read More */}
                <div 
                    className={`absolute w-full max-w-[800px] h-[150px] lg:h-[200px] left-1/2 -translate-x-1/2 bottom-0 flex flex-col justify-end items-center px-[10px] py-[24px] gap-[10px] z-30 pointer-events-none transition-all duration-500 ${isExpanded ? 'opacity-0 translate-y-4 pointer-events-none' : 'opacity-100 translate-y-0'}`}
