...
export default function AboutSection() {
    ...
    return (
        <section className="flex flex-col items-center lg:items-start p-0 gap-[24px] lg:gap-[40px] w-full max-w-[1136px] mx-auto px-0 lg:px-0">
            <div 
                className={`flex flex-col items-center p-0 gap-[24px] lg:gap-[32px] w-full max-w-[1136px] relative isolate overflow-hidden transition-all duration-500 ease-in-out ${isExpanded ? 'max-h-[3000px]' : 'h-[910px] md:max-h-[600px] lg:max-h-[708px]'}`}
            >
                {/* 1st Group */}
                <div className="flex flex-col items-start p-0 gap-[16px] lg:gap-[24px] w-[374px] max-w-full md:w-full lg:w-[800px] flex-none z-0">
                    <h2 className="w-full font-['Jost'] font-bold text-[22px] md:text-[28px] lg:text-[32px] leading-[26px] md:leading-[120%] tracking-[-0.02em] text-white flex-none m-0">
                        Play the Best Crypto Casino Games Online at Mighty Luck — Fast, Fair and Secure
                    </h2>
                    <p className="w-full font-['Manrope'] font-medium text-[16px] md:text-[15px] lg:text-[16px] leading-[26px] md:leading-[160%] text-[#D2DCF7] flex-none m-0 whitespace-pre-wrap">
                ...
                {/* 2nd Group */}
                <div className="flex flex-col items-start p-0 gap-[12px] lg:gap-[16px] w-[374px] max-w-full md:w-full lg:w-[800px] flex-none z-10 pb-[60px]">
                    <h3 className="w-full font-['Jost'] font-bold text-[18px] md:text-[22px] lg:text-[24px] leading-[26px] lg:leading-[35px] text-white flex-none m-0">
