...
export default function AboutSection() {
    return (
        <section className="flex flex-col items-start gap-[40px] w-[1136px] h-[708px] shrink-0">
            <div className="flex flex-col items-center gap-[32px] w-[1136px] h-[708px] shrink-0 relative overflow-hidden isolate">
                
                <div className="flex flex-col items-start gap-[24px] w-[800px] h-[412px] shrink-0">
                    <h2 className="w-[800px] font-['Jost'] font-bold text-[32px] leading-[120%] tracking-[-0.02em] text-white">
                        Play the Best Crypto Casino Games Online at Mighty Luck — Fast, Fair and Secure
                    </h2>
                    <p className="w-[800px] font-['Manrope'] font-medium text-[16px] leading-[160%] text-[#D2DCF7] whitespace-pre-wrap">
                ...
                <div className="flex flex-col items-start gap-[16px] w-[800px] h-[129px] shrink-0">
                    <h3 className="w-[800px] font-['Jost'] font-bold text-[24px] leading-[35px] text-white">
                ...
                <div className="flex flex-col items-start gap-[16px] w-[800px] h-[103px] shrink-0">
                    <h3 className="w-[800px] font-['Jost'] font-bold text-[24px] leading-[35px] text-white">
                ...
                <div className="absolute w-[800px] h-[200px] left-1/2 -translate-x-1/2 bottom-0 bg-gradient-to-t from-[#091741] to-transparent flex flex-col justify-end items-center px-[10px] pb-[24px] gap-[10px] z-10 pointer-events-none">
