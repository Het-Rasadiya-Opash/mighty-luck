        ...
        <section className="w-full flex flex-col gap-[20px]">
            ...
            >
                <div className="min-w-[610px] w-full flex flex-col">
                    <div className="flex items-center px-[12px] md:px-[24px] w-full h-[14px] md:h-[20px] mb-[8px] md:mb-[12px] gap-[40px] md:gap-[12px]">
                        <div className="w-[220px] shrink-0 font-['Jost'] font-bold text-[10px] md:text-[14px] leading-[14px] md:leading-[20px] tracking-[0.02em] uppercase text-white md:text-white/50">
                            GAME
                        </div>
                        <div className="flex items-center gap-[8.41px] md:gap-[12px] flex-1 shrink-0 font-['Jost'] font-bold text-[9.81px] md:text-[14px] leading-[14px] md:leading-[20px] tracking-[0.02em] uppercase text-white md:text-white/50">
                            <div className="w-[189.18px] md:w-[180px] lg:w-[300px] shrink-0">USERNAME</div>
                            <div className="w-[60px] md:w-[100px] lg:w-[150px] shrink-0">TIME</div>
                            <div className="w-[60px] md:w-[80px] lg:w-[150px] text-right shrink-0">PAYOUT</div>
                        </div>
                    </div>
                    ...
                    <div className="w-full flex flex-col gap-[8px]">
                        {recentWinners.map((winner) => (
                            <div
                                key={winner.id}
                                className="w-full bg-[#0C1F56] rounded-[5.61px] md:rounded-[8px] px-[12px] md:px-[24px] py-[8.41px] md:py-0 h-[42px] md:h-[60px] flex items-center gap-[40px] md:gap-[12px]"
                            >
                                <div className="flex items-center gap-[8.41px] md:gap-[12px] w-[220px] shrink-0 min-w-0">
                                ...
                                <div className="flex items-center gap-[8.41px] md:gap-[12px] flex-1 shrink-0">
                                    <span className="w-[189.18px] md:w-[180px] lg:w-[300px] font-['Manrope'] font-semibold text-[12px] md:text-[14px] leading-[16px] md:leading-[19px] tracking-[0.02em] text-white truncate shrink-0">
                                        {winner.user}
                                    </span>
                                    <span className="w-[60px] md:w-[100px] lg:w-[150px] font-['Manrope'] font-semibold text-[12px] md:text-[14px] leading-[16px] md:leading-[19px] tracking-[0.02em] text-white shrink-0">
                                        {winner.time}
                                    </span>
                                    <span className={`w-[60px] md:w-[80px] lg:w-[150px] font-['Manrope'] font-semibold text-[12px] md:text-[14px] leading-[16px] md:leading-[19px] tracking-[0.02em] text-right shrink-0 ${winner.payoutColor}`}>
                                        {winner.payout}
                                    </span>
                                </div>
                            </div>
