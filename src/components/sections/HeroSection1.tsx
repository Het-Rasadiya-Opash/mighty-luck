...
export default function HeroSection1() {
  return (
    <div className="relative flex flex-col sm:flex-row justify-between items-center w-full p-[20px] sm:px-6 md:px-[40px] md:py-0 h-[165px] sm:h-auto md:h-[100px] bg-[#0C1F56] rounded-[10px] sm:rounded-[16px] shrink-0 overflow-hidden gap-[20px] sm:gap-3">
      ...
      <div className="relative z-10 flex items-center justify-between sm:justify-center flex-wrap content-start gap-x-[12px] gap-y-[20px] sm:gap-4 md:gap-[20px] lg:gap-[28px] w-[334px] h-[19.05px] sm:w-auto sm:h-auto sm:max-w-full m-0 p-0">
      ...
      <button className="relative z-10 flex justify-center items-center px-[30px] py-[10px] sm:px-4 md:px-[24px] gap-[10px] w-[148px] sm:w-[136px] h-[40px] bg-[#FFC83D] rounded-[8px] shrink-0">
        <span
