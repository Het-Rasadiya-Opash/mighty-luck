...
export default function Sidebar() {
    ...
    return (
        <aside className="hidden lg:flex w-[232px] flex-col gap-[10px] shrink-0">
            <div className="w-full bg-[#0C1F56] rounded-[16px] p-[16px] flex flex-col gap-[10px]">
                <div className="flex gap-[10px]">
                    <div className="flex-1 h-[44px] bg-gradient-to-r from-[#B42FF4] to-[#3B005F] rounded-[8px] flex items-center justify-start px-[6px] gap-[2px]">
                    ...
                    <div className="flex-1 h-[44px] bg-gradient-to-r from-[#F51BB7] to-[#500039] rounded-[8px] flex items-center justify-start px-[6px] gap-[2px]">
                ...
                <div className="w-full h-[50px] bg-gradient-to-r from-[#3F31FF] to-[#091741] rounded-[8px] flex items-center justify-start px-[12px] gap-[8px]">
